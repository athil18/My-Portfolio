...
// Each category has a set of curated Unsplash photo IDs for high-quality, consistent imagery

const categoryImages: Record<string, { primary: string[]; contextual: string[] }> = {
    'Electronics': {
        primary: [
            'photo-1505740420928-5e560c06d30e', // headphones
            'photo-1546435770-a3e426bf472b', // smartwatch
            'photo-1593642632559-0c6d3fc62b89', // earbuds
            'photo-1526738549149-8e07eca6c147', // camera
            'photo-1608043152269-423dbba4e7e1', // speaker
            'photo-1585792180666-f7347c490ee2', // projector
            'photo-1625961332771-3f40b0e2bdcf', // hub
    ...
    'Fashion': {
        primary: [
            ...
            'photo-1539533018447-63fcce2678e3', // overcoat
            'photo-1542291026-7eec264c27ff', // sneakers
            'photo-1601924994987-69e26d50dc26', // scarf
            'photo-1576995853123-5a10305d93c0', // denim jacket
    ...
    'Home & Garden': {
        primary: [
            'photo-1565814329452-e1efa11c5b89', // LED bulb
            'photo-1580480055273-228ff5388ef8', // office chair
            'photo-1459411552884-841db9b3cc2a', // plants
            'photo-1631049307264-da0ec9d70304', // mattress
            'photo-1556909114-44e3e70034e2', // cookware
            'photo-1558618666-fcd25c85cd64', // robot vacuum
            'photo-1605117882932-f9e32b03fea9', // cutting board
            'photo-1585771724684-38269d6639fd', // air purifier
        ],
    ...
    'Sports & Outdoors': {
        primary: [
            ...
            'photo-1504280390367-361c6d9f38f4', // camping tent
            'photo-1534438327276-14e5300c3a48', // dumbbells
            'photo-1510017803434-a899398421b3', // GPS watch
            'photo-1558618666-fcd25c85cd64', // helmet
    ...
    'Beauty & Health': {
        primary: [
            ...
            'photo-1559056199-641a0ac8b55e', // toothbrush
            'photo-1522338242042-3e7d574f0666', // hair dryer
            'photo-1596462502278-27bfdc403348', // skincare
            'photo-1617897903246-719242758050', // massage gun
            'photo-1608571423902-eed4a5ad8108', // essential oils
            'photo-1612817288484-6f916006741a', // LED mask
            'photo-1602928298849-325cec8771c0', // diffuser
        ],
        contextual: ['photo-1571875257727-256c39da42af', 'photo-1576426863848-c21f53c60b19', 'photo-1512496015851-a90fb38ba796']
    },
    'Books & Media': {
        primary: [
            'photo-1544716278-ca5e3f4abd8c', // books
            'photo-1544947950-fa07a98d237f', // programming book
            'photo-1539375665275-f9de415ef9ac', // vinyl player
            'photo-1544947950-fa07a98d237f', // e-reader
            'photo-1507003211169-0a1dd7228f2d', // audiobook
            'photo-1524995997946-a1c2e315a42f', // encyclopedia
            'photo-1456513080510-7bf3a84b82f8', // language kit
            'photo-1553729459-efe14ef6055d', // photography guide
        ],
        contextual: ['photo-1507842217343-583bb7270b66', 'photo-1495446815901-a7297e633e8d', 'photo-1512820790803-83ca734da794']
    },
    'Toys & Games': {
        primary: [
            'photo-1558060370-d644479cb6f7', // building blocks
            'photo-1507582020474-9a35b7d455d9', // drone
            'photo-1610890716171-6b1bb98ffd09', // board games
            'photo-1587654780291-39c9404d746b', // STEM kit
            'photo-1558060370-d644479cb6f7', // plush toys
            'photo-1606144042614-b2417e99c4e3', // console
            'photo-1486572788966-cfd3df1f5b42', // puzzle
            'photo-1513542789411-b6a5d4f31634', // art supplies
        ],
        contextual: ['photo-1566576912321-d58ddd7a6088', 'photo-1596461404969-9ae70f2830c1', 'photo-1560421683-6856ea585c78']
    },
    'Automotive': {
        primary: [
            'photo-1617788138017-80ad40651399', // dash cam
            'photo-1581235720704-06d3acfcb36f', // phone mount
            'photo-1558618666-fcd25c85cd64', // tire monitor
            'photo-1489824904134-891ab64532f1', // headlight
            'photo-1503376780353-7e6692767b70', // seat covers
            'photo-1558618666-fcd25c85cd64', // jump starter
            'photo-1558618666-fcd25c85cd64', // car vacuum
            'photo-1502877338535-766e1452684a', // GPS
        ],
        contextual: ['photo-1494976388531-d1058494cdd8', 'photo-1549317661-bd32c8ce0db2', 'photo-1552519507-da3b142c6e3d']
    },
    'Food & Beverages': {
        primary: [
            'photo-1447933601403-0c6688de566e', // coffee
            'photo-1549007994-cb92caebd54b', // chocolate
            'photo-1556679343-c7306c1976bc', // tea
            'photo-1593095948071-474c5cc2989d', // protein
            'photo-1474979266404-7eaacbcd87c5', // olive oil
            'photo-1558642452-9d2a7deb7f62', // honey
            'photo-1596040033229-a9821ebd058d', // spice rack
            'photo-1546069901-ba9599a7e63c', // snacks
        ],
        contextual: ['photo-1490818387583-1baba5e638af', 'photo-1504754524776-8f4f37790ca0', 'photo-1512621776951-a57141f2eefd']
    },
    'Office Supplies': {
        primary: [
            'photo-1593642632559-0c6d3fc62b89', // standing desk
            'photo-1527864550417-7fd91fc51a46', // mouse
            'photo-1531346878377-a5be20888e57', // notebook
            'photo-1507925921958-8a62f3d1a50d', // desk organizer
            'photo-1593642632559-0c6d3fc62b89', // monitor light
            'photo-1532153975070-2e9ab71f1b14', // whiteboard
            'photo-1585336261022-680e295ce3fe', // pen set
            'photo-1507925921958-8a62f3d1a50d', // filing cabinet
        ],
        contextual: ['photo-1497366216548-37526070297c', 'photo-1497366811353-6870744d04b2', 'photo-1542744173-8e7e53415bb0']
    },
    'Pet Supplies': {
        primary: [
            'photo-1601758125946-6ec2ef64daf8', // pet feeder
            'photo-1587300003388-59208cc962cb', // dog bed
            'photo-1545249390-6bdfa286032f', // cat tree
            'photo-1601758174493-b8e4e40e6a13', // GPS tracker
            'photo-1516734212186-a967f81ad0d7', // grooming kit
            'photo-1520301255226-bf5f144451c1', // aquarium
            'photo-1452570053594-1b985d6ea890', // bird cage
            'photo-1544568100-847a948585b9', // pet carrier
        ],
    ...
    'Jewelry': {
        primary: [
            ...
            'photo-1611652022419-a9419f74343d', // bracelet
            'photo-1524805444758-089113d48a6d', // watch
            'photo-1605100804763-247f67b3557e', // ring
            'photo-1594534475808-b18fc33b045e', // wedding band
            'photo-1515562141207-7a88fb7ce338', // pendant
            'photo-1573408301185-9146fe634ad0', // leather cuff
        ],
...
async function enrichProducts() {
    ...
    try {
        ...
        for (const product of products) {
            ...
            // Get a consistent image based on product index within category
